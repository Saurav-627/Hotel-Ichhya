...
from dashboard.forms import RoomForm, RoomCategoryForm, RoomFacilityForm, RoomPriceForm, RoomImageForm, RoomPolicyForm
...
class RoomDashboardView(StaffRequiredMixin, View):
    def get(self, request):
        ...
        return render(request, 'dashboard/rooms/dashboard.html', {
            'rooms': rooms,
...
class RoomCreateView(StaffRequiredMixin, View):
    def get(self, request):
        ...
        return render(request, 'dashboard/rooms/form.html', {
            'form': form,
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            if image_formset.is_valid() and policy_formset.is_valid() and price_formset.is_valid():
                ...
                return redirect('dashboard:room_dashboard')
            else:
...
class RoomDeleteView(StaffRequiredMixin, DeleteView):
    ...
    success_url = reverse_lazy('dashboard:room_dashboard')
    
    def get_success_url(self):
        messages.success(self.request, "Room deleted successfully.")
        return reverse_lazy('dashboard:room_dashboard')
...
class RoomCategoryCreateView(StaffRequiredMixin, CreateView):
    ...
    def get_success_url(self):
        ...
        return reverse_lazy('dashboard:room_dashboard') + "?tab=categories"
...
class RoomFacilityCreateView(StaffRequiredMixin, CreateView):
    ...
    def get_success_url(self):
        ...
        return reverse_lazy('dashboard:room_dashboard') + "?tab=facilities"
...
class RoomAvailabilityCalendarView(StaffRequiredMixin, View):
    def get(self, request):
        ...
        return render(request, 'dashboard/rooms/calendar.html', {
            'rooms': rooms,
...
class RoomBulkPriceUpdateView(StaffRequiredMixin, View):
    def post(self, request):
        ...
        adjustment_value = float(request.POST.get('adjustment_value', 0))
        ...
        for room in rooms:
            if adjustment_type == 'percentage':
                ...
                room.base_price = room.base_price * (1 + adjustment_value / 100)
            else:
